// Enhanced Wallet Crypto Service for YAP-Landing
...
export class WalletCryptoService {
  ...
  private async deriveSeiWallet(mnemonic: string): Promise<{
    ...
    try {
      // Create DirectSecp256k1HdWallet from mnemonic
      ...
      const privateKey = Buffer.from(wallet.privkey || new Uint8Array()).toString('hex');
