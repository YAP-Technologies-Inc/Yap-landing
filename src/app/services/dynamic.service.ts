...
export class DynamicService {
  ...
  /**
   * Update wallet info with actual data from the Dynamic web component
   * @param walletAddress The wallet address from Dynamic.xyz
   * @param userId The Dynamic.xyz user ID
   */
  updateFromWebComponent(walletAddress: string, userId: string): void {
    const walletInfo: WalletInfo = {
      seiWalletAddress: walletAddress,
    ...
    // Store in localStorage
    localStorage.setItem('walletInfo', JSON.stringify(walletInfo));
    console.log('Updated wallet info from web component:', walletInfo);
  }
